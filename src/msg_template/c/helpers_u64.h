static inline void seridl_write_u64_le(uint64_t value, uint8_t *out) {
...
static inline uint64_t seridl_read_u64_le(const uint8_t *in) {
...
static inline void seridl_write_u64_be(uint64_t value, uint8_t *out) {
...
static inline uint64_t seridl_read_u64_be(const uint8_t *in) {
